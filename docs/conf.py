...
globals()["exclude_patterns"] = exclude_patterns

# This is added to the end of RST files - a good place to put substitutions to
# be used globally.
rst_epilog = globals().get("rst_epilog", "")
rst_epilog += """
"""
...
modindex_common_prefix = ["flipbook."]
...
linkcheck_retry = 5
linkcheck_ignore = [
    r"https://github\.com/flipbook/flipbook/(?:issues|pull)/\d+",
]
